...
namespace _02._Pawn_Wars
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                if (IsInMatrix(whiteCurrRow - 1, whiteCurrCol - 1) && matrix[whiteCurrRow - 1, whiteCurrCol - 1] == 'b') //left
                {
                ...
                else if (IsInMatrix(whiteCurrRow - 1, whiteCurrCol + 1) && matrix[whiteCurrRow - 1, whiteCurrCol + 1] == 'b') //right
                {
                    string position = SetPosition(whiteCurrRow - 1, whiteCurrCol + 1);
                    Console.WriteLine($"Game over! White capture on {position}.");
                    break;
                ...
                else
                {
                    ...
                    if (whiteCurrRow == 0) //reach end of board
                    {
                ...
                if (IsInMatrix(blackCurrRow + 1, blackCurrCol - 1) && matrix[blackCurrRow + 1, blackCurrCol - 1] == 'w') //right
                {
                    string position = SetPosition(blackCurrRow + 1, blackCurrCol - 1);
                    Console.WriteLine($"Game over! Black capture on {position}.");
                    break;
                }
                else if (IsInMatrix(blackCurrRow + 1, blackCurrCol + 1) && matrix[blackCurrRow + 1, blackCurrCol + 1] == 'w') //left
                {
                    string position = SetPosition(blackCurrRow + 1, blackCurrCol + 1);
                    Console.WriteLine($"Game over! Black capture on {position}.");
                    break;
                ...
                else
                {
                    ...
                    if (blackCurrRow == 7) //reaches end of board
                    {
