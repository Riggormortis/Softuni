namespace CarManager.Tests
{
    ...
    public class CarManagerTests
    {
        ...
        [TestCase("Make", "Model", 10.0, -100.0)]
        public void Ctor_ThrowsExceptionWhenAParameterIsInvalid (string make, string model, double fuelConsumption, double fuelCapacity)
        {
            Assert.That(() => new Car(make, model, fuelConsumption, fuelCapacity), Throws.ArgumentException);
        }

        [Test]
        public void Ctor_SetsValuesToGivenParametersWhenValuesAreValid()
        {
            string make = "Make";
            string model = "Model";
        ...
        [TestCase(0.0)]
        [TestCase(-10.0)]
        public void Refuel_ThrowsExceptionWhenGivenParameterIsEqualToOrLessThanZero(double fuelToRefuel)
        {
            Assert.That(() => this.car.Refuel(fuelToRefuel), Throws.ArgumentException, "Fuel amount cannot be zero or negative!");
        }

        [Test]
        public void Refuel_IncreasesFuelAmount_WithGivenParameterWhenParameterIsValidAndThereIsEnoughFuelCapacity()
        {
        ...
        [Test]
        public void Refuel_IncreasesFuelAmountToFuelCapacityWhenGivenParameterIsValidButThereIsNotEnoughFuelCapacity()
        {
            double fuelToRefuel = this.car.FuelCapacity * 2;
        ...
        [Test]
        public void Drive_ThrowsExceptionWhenRequiredFuelIsMoreThanFuelAmount()
        {
            double fuelToRefuel = this.car.FuelCapacity / 2;
            this.car.Refuel(fuelToRefuel);
        ...
        [Test]
        public void Drive_ReducesFuelAmountToZeroWhenRequredFuelIsEqualToFuelAmount()
        {
            double fuelToRefuel = this.car.FuelCapacity / 2;
            this.car.Refuel(fuelToRefuel);
        ...
        [Test]
        public void Drive_ReducesFuelAmountWithRequiredFuelWhenRequiredFuelIsLessThanFuelAmount()
        {
            double fuelToRefuel = this.car.FuelCapacity / 2;
            this.car.Refuel(fuelToRefuel);
