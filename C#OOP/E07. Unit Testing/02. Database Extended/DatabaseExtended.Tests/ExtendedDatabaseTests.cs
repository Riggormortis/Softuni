namespace DatabaseExtended.Tests
{
    ...
    public class ExtendedDatabaseTests
    {
        ...
        [Test]
        public void PersonCtorCreatesAnInstanceWithInitialParameters()
        {
            long personId = 1;
        ...
        [Test]
        public void Add_ThrowsExeptionWhenCapacityIsExceeded()
        {
            ...
            Assert.That(() => this.database.Add(new Person(Capacity, $"Username{Capacity}")), Throws.InvalidOperationException, "Array's capacity must be exactly 16 integers!");
        }

        [Test]
        public void Add_ThrowsExceptionWhenAddingAPersonWithAlreadyUsedUsername()
        {
            string personUsername = "Username";
        ...
        [Test]
        public void Add_AddsElementToDatabaseWhenParametersAreValid()
        {
            long personId = 0;
            string personUsername = "Username";
        ...
        [Test]
        public void Ctor_AddInitialPeopleToDatabaseWhenGivenArgumentIsValid()
        {
        ...
        [Test]
        public void Remove_ThrowsExceptionWhenDatabaseIsEmpty()
        {
            Assert.That(() => this.database.Remove(), Throws.InvalidOperationException, "Cannot remove from empty database!");
        }

        [Test]
        [TestCase(1)]
        [TestCase(5)]
        public void Remove_DecreasesCountByOneEverytimeElementIsRemoved(int countOfElementsToRemove)
        {
            Person[] initialPeople = new Person[Capacity];
        ...
        [TestCase(null)]
        [TestCase("")]
        public void FindByUsername_ThrowsExceptionWhenGivenUsernameIsNullOrEmpty(string givenUsername)
        {
        ...
        [Test]
        public void FindByUsername_ThrowsExceptionWhenThereIsNoPersonWithTheGivenUsername()
        {
        ...
        [Test]
        public void FindByUsername_ReturnsThePersonWithTheGivenUsernameWhenDatabaseContainsIt()
        {
            long personId = 0;
            string personUsername = "Username";
        ...
        [Test]
        public void FindById_ThrowsExceptionWhenGivenIdIsLessThanZero()
        {
            long givenId = -10;
        ...
        [Test]
        public void FindById_ThrowsExceptionWhenThereIsNoPersonWithTheGivenId()
        {
            int countOfPeopleForAdding = 5;
        ...
        [Test]
        public void FindById_ReturnsThePersonWithTheGivenIdWhenDatabaseContainsIt()
        {
            long personId = 0;
            string personUsername = "Username";
